...
def create_lead(lead_dict):
    leads = read_leads()                      #DESAFIO: Corrigir para não precisar ler o arquivo inteiro
    leads.append(lead_dict)
    DB_PATH.write_text(json.dumps(leads, ensure_ascii=False, indent=2), encoding="utf-8")

def read_leads_search(query):
    """Busca leads de acordo com a query e RETORNA uma lista de resultados"""
    leads = read_leads()
    results = []
...
def export_csv():
    """Exportar TODOS os leads para CSV e RETORNA o caminho do CSV"""
